...
export const UI_COPY = {
  ...
  socialToolkitReasonInvalidAssetForPreset: {
    en: "Asset type is not allowed for this preset",
    zh: "该预设不允许此素材类型",
  },
  ...
  socialToolkitLabelDownloadAssetAria: { en: "Download {asset} PNG", zh: "下载 {asset} PNG" },
  socialToolkitLabelDownloadFrameAria: { en: "Download carousel frame {frame} PNG", zh: "下载轮播帧 {frame} PNG" },
  socialToolkitLabelPreview: { en: "Preview", zh: "预览" },
  socialToolkitLabelPreviewFrameAria: { en: "Preview carousel frame {frame}", zh: "预览轮播帧 {frame}" },
